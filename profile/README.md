...
| Broadcast / many-to-many data distribution from PLCs to consumers, no client-server session | PubSub (Part 14) | `opcua-client-ext-pubsub` *(in development)* |
