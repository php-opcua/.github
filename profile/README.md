...
| **opcua-client-ext-transport-pubsub** | <div><p align="center"><img src="https://img.shields.io/badge/status-in%20development-F59E0B?style=flat-square" alt="In development — not production-ready"></p>OPC UA Pub/Sub extension for `opcua-client`. Publisher/subscriber support for the OPC UA Part 14 Pub/Sub specification.</div> |
...
| Broadcast / many-to-many data distribution from PLCs to consumers, no client-server session | PubSub (Part 14) | `opcua-client-ext-transport-pubsub` *(in development)* |
